...
## Purpose
Defines how comic-style or heavily-illustrated PDF pages are detected and, optionally, described by a local vision model - and how that content is kept distinguishable from directly-extracted text throughout chunking, storage, retrieval, and chat citations.
